...
import {addNewForm, copyLinkToClipboard, deleteForm, getNearbyPlaceDetail, handleAddressSelect, handleSubmit, populateFormsData, sendNearbyPlacesAPIRequest, setCenterAndNearbyPlaces, setHeatMapData, setNearbyPlaceDetail, setNearbyPlaces, setNearbyPlacesAroundPseudoCenter, suggestOtherNearbyPlaces} from "./helpers";
import MapHolder1 from "../mapHolder1/MapHolder1";
...
class Middle1 extends Component {
    ...
    constructor(props) {
        ...
        this.setNearbyPlacesAroundPseudoCenter = setNearbyPlacesAroundPseudoCenter.bind(this);
    }
                ...
                <div className="search-results-block">
                    ...
                    <div className="tabset">
                        ...
                        <div id="map" className="b-tab">
                            {this.state.canRenderMap ? <MapHolder1 google={this.props.google} forms_count={this.state.forms_count}
                                                                  ...
                                                                  setNearbyPlacesAroundPseudoCenter={this.setNearbyPlacesAroundPseudoCenter}
                            /> : "Loading..."}
                        </div>
                    </div>
                </div>
