                    ...
                    {({getInputProps, suggestions, getSuggestionItemProps, loading}) => (
                        <div>
                            <div className="input-holder">
                                ...
                                {this.props.canDelete && <span className="location-delete"><button onClick={(event) => this.props.deleteForm(event, this.props.form_key)}><i className="fa fa-trash"/></button></span>}
                                <span className="target-location"><button onClick={(event) => this.props.setMapCenter(event, this.props.form_key)}><i className="icon-target"/></button></span>
