        ...
        return (
            <div>
                <div className="input-holder">
                    <input type="text" placeholder="Enter your nickname or initials" value={this.props.name} onChange={(event) => {this.props.setName(event, this.props.form_key)}} maxLength={200} required/>
                </div>
