...
import {addNewForm, copyLinkToClipboard, deleteForm, getNearbyPlaceDetail, handleAddressSelect, handleSubmit, moveCenterToNewLocation, populateFormsData, sendNearbyPlacesAPIRequest, setCenterAndNearbyPlaces, setHeatMapData, setNearbyPlaceDetail, setNearbyPlaces, suggestOtherNearbyPlaces} from "./helpers";
import MapHolder2 from "../mapHolder2/MapHolder2";
...
class Middle2 extends Component {
    ...
    constructor(props) {
        ...
        this.moveCenterToNewLocation = moveCenterToNewLocation.bind(this);
    }
                ...
                <div className="search-results-block">
                    ...
                    <div className="tabset">
                        ...
                        <div id="map" className="b-tab">
                            {this.state.canRenderMap ? <MapHolder2 google={this.props.google} forms_count={this.state.forms_count}
                                                                  ...
                                                                  moveCenterToNewLocation={this.moveCenterToNewLocation}
                            /> : "Loading..."}
                        </div>
                    </div>
                </div>
